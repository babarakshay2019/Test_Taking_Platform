"""
Django settings for Test_Taking_Platform project.
...
SECRET_KEY = 'django-insecure-3frhwf_p-n_mkw42cs)wztd91#mhkn#&#0_@wd(c@n9n(f))c6'
...
WSGI_APPLICATION = 'Test_Taking_Platform.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=120),  # Adjust token lifetimes as needed
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Test-Taking Platform API',
    'DESCRIPTION': 'API documentation for the Test-Taking Platform',
    'VERSION': '1.0.0',
